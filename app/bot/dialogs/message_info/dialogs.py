...
main_window = Window(
    ...
    SwitchTo(
        Const(buttons_texts.DEL_MESSAGE),
        id='btn_del_message',
...
change_message_name_window = Window(
    ...
    TextInput(
        ...
        type_factory=str,
        on_success=handlers.update_message_name,
    ),
    MessageInput(func=other_handlers.no_text),
    SwitchTo(
        Const(buttons_texts.CANCEL),
        id='btn_change_message_name_cancel',
        state=MessageInfoSG.start,
    ),
    state=MessageInfoSG.change_message_name,
...
change_message_text_window = Window(
    ...
    TextInput(
        ...
        type_factory=str,
        on_success=handlers.update_message_text,
    ),
    MessageInput(func=other_handlers.no_text),
    SwitchTo(
        Const(buttons_texts.CANCEL),
        id='btn_change_message_text_cancel',
        state=MessageInfoSG.start,
    ),
    state=MessageInfoSG.change_message_text,
...
change_message_datetime_window = Window(
    ...
    Row(
        ...
        SwitchTo(
            Const(buttons_texts.CANCEL),
            id='btn_change_message_datetime_cancel',
            state=MessageInfoSG.start,
        ),
    ),
    state=MessageInfoSG.change_message_datetime,
...
confirm_del_message_window = Window(
    Format(
        '⚠️ Вы точно хотите удалить сообщение "{message_name}"?'
    ),  # TODO: изменить на название
    Row(
        Button(
            text=Const(buttons_texts.YES),
            id='btn_del_message_yes',
            on_click=handlers.del_message,
        ),
        SwitchTo(
            text=Const(buttons_texts.NO),
            id='btn_del_message_no',
            state=MessageInfoSG.start,
        ),
    ),
    state=MessageInfoSG.del_message_confirm,
